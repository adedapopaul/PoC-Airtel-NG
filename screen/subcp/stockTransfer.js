...
export  class StockTransferScreen extends Component {
  ...
  _activate = async () => {
    ...
    let message = `ST ${this.state.msidn} ${this.state.amount} ${pin}`
    ...
    var msg = `Sub CP Stock Transfer to ${this.state.msidn}.\n    Date/Time: ${date}.`
...
const mapStateToProps = state => ({
  ...
  pin: state.subCpAccount.subCpAccount.pin,
  sections: state.history,
})

export default connect(mapStateToProps, {subCpAccountAction,licence, history})(StockTransferScreen)