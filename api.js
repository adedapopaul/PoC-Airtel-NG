...
export const trialLicence = async (username, serial, imei, phoneSerial) => {
	const response = await fetch('https://cardgenerationserver.herokuapp.com/v1/trialLicence/licence', {
	    method: 'PUT',
	    headers: {'content-type': 'application/json'},
	    body: JSON.stringify({
		    username,
